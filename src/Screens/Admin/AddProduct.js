...
const AddProduct =()=>{
  ...
  function writeData() {
    ...
    <View style={styles.container}>
      ...
      <TextInput style={styles.input} placeholder="Title*" placeholderTextColor={'#62442B'} value={Title} onChangeText={text=>{setTitle(text)}}/>
      <TextInput style={styles.input}   placeholder="Price*"  placeholderTextColor={'#62442B'} value ={Price}onChangeText={text=>{setPrice(text)}} keyboardType="numeric"/>
      <TextInput style={styles.textarea}   placeholder="Description" placeholderTextColor={'#62442B'} value={Description}onChangeText={text=>{setDescription(text)}}/>
      ...
      <SelectDropdown defaultButtonText={Category} data={categories} buttonStyle={{width:300, height:66,backgroundColor:'#FDF4E7',borderRadius:4,}}
